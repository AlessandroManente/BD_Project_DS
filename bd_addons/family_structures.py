...
def parse_tmalign_out(filename):
    ...
    lines = []
    # temp_path =
    # ".\\data_team_1\\_part_2\\original_datasets\\family_structures\\temp"
    temp_path = path.join('data_team_1', '_part_2', 'original_datasets',
...
def create_rmsd_matrix(best_model):
    ...
    # model_path =
    # ".\\data_team_1\\_part_2\\original_datasets\\family_structures\\pdbs_{}".format(best_model)
    model_path = path.join('data_team_1', '_part_2', 'original_datasets',
    ...
    if 'rmsds_{}.csv'.format(best_model) in os.listdir(model_path):
        ...
        dir_to_parse = path.join('data_team_1', '_part_2', 'original_datasets',
                                 'family_structures', 'temp')
...
def create_tmscores_matrix(best_model):
   ...
   stores them into a matrix and saves it into a .csv.
    ...
    # model_path = ".\\data_team_1\\_part_2\\original_datasets\\family_structures\\pdbs_{}".format(
    #     best_model)
    model_path = path.join('data_team_1', '_part_2', 'original_datasets',
                           'family_structures', 'pdbs_{}'.format(best_model))
...
def clear_temp_folder():
    ...
    temp_dir = path.join('data_team_1', '_part_2', 'original_datasets',
                         'family_structures', 'temp')
