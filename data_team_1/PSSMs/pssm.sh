...
../../../binx/ncbi-blast-2.11.0+/bin/psiblast -db ../../../data/msa/uniprot_sprot.fasta -in_msa ../MSAs/MSA_${msamethod}_${try}.fa -out_ascii_pssm pssm_${msamethod}_${try}.txt -out out_psiblast_${msamethod}_${try}.xml -outfmt 5